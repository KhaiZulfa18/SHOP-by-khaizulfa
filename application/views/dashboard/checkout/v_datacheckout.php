      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-info" id="dpdf"><i class="fa fa-download"></i>&nbsp;PDF</button> 
...
<script src="<?php echo base_url(); ?>js/checkout/data_checkout.js?v=1.0.2" type="text/javascript"></script>
</body>
</html>