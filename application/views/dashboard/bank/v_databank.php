            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group col-md-12 input-group">
                  <div class="col-sm-6">
                  <a href="<?php echo base_url('tools/input_metodepembayaran'); ?>">
                      <button class="btn btn-md btn-info"><i class="fa fa-plus"></i>Tambah</button>
                  </a>
                  </div>
                </div>
                <div class="form-group col-md-12 input-group">
...
<script src="<?php echo base_url(); ?>js/bank/data_bank.js?v=1.0.0" type="text/javascript"></script>
</body>
</html>