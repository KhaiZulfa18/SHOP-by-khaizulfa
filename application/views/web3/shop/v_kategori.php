	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container-fluid">
			<div class="inner-sec-shop px-lg-4 px-3">
				...
				<h3 class="tittle-w3layouts my-lg-4 my-4"><?php echo $nama_ktg; ?> </h3>
				<div class="row">
					<!-- product left -->
...
<script src="<?php echo base_url(); ?>js/shop/cart.js?v=1.0.1" type="text/javascript"></script>
</html>