							...
							<div class="col-md-6 address-center text-left">
								<div class="col-md-12 address-right text-left  mt-1">
									<ul class="list-group">
										<li class="list-group">
											<h5><b>Telepon</b></h5>
											<input type="number" class="form-control" id="telepon" name="telepon" value="<?php echo $akun->telepon; ?>">
										</li>
										<hr>
										<li class="list-group">
											<h5><b>Gender</b></h5>
										...
										<li class="list-group">
											<h5><b>Alamat</b></h5>
											<textarea class="form-control" id="alamat" name="alamat"><?php echo $akun->alamat; ?></textarea>
										</li>
										<hr>
									</ul>
								</div>
...
<script src="<?php echo base_url(); ?>js/account/ubah_profil.js?v=1.0.1" type="text/javascript"></script>
