...
<html lang="en">
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Data Author</li>
						</ul><!-- /.breadcrumb -->
					</div>
								...
								<div class="row">
									...
									<div class="col-sm-4 form-group">
										<select id="status" class="form-control" style="width: 100%">
											...
											<option value="activ">Aktif</option>
											<option value="unactiv">Non-Aktif</option>
										</select>
									</div>
									<div class="col-sm-4 form-group">
		...
		<script src="<?php echo base_url(); ?>js/data_author.js?v=1.0.9" type="text/javascript"></script>
